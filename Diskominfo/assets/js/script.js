...
function initializeVisitorCounter() {
    const visitorCountElements = document.querySelectorAll('#visitor-count, #footer-visitor-count');
...
function displaySearchResults(results, query) {
    ...
    if (results.length === 0) {
        searchResults.innerHTML = '<div class="p-3 text-muted">Tidak ada hasil ditemukan.</div>';
        return;
    }
